...
df=readCsv("C:/Users/abdif/OneDrive/Documents/prog/tr_types.csv",";")
#print(task2(df))
df=readCsv("C:/Users/abdif/OneDrive/Documents/prog/transactions.csv",",")
df=pd.read_csv("C:/Users/abdif/OneDrive/Documents/prog/transactions.csv",sep=",",index_col='customer_id')
print(df)
print(task3(df))
print(task1(df))
print(task4(df))
